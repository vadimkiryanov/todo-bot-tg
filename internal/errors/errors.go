...
var (
	...
	// Закреплённые (быстрые) топики: строка кнопок в боте вмещает не больше
	// десяти, поэтому и закрепить в вебе можно не больше десяти.
	ErrTooManyQuickTopics = errors.New("можно закрепить не больше 10 топиков")
)
